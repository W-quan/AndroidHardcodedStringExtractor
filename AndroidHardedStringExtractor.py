...
配合rigrep 或者 ack 搜索出需要extract的地方

explamples:

搜索代码中的中文string:    rg '".*[\u4e00-\u9fa5].*"' -tjava -tkotlin --line-number > text.txt

搜索layout文件中的string:   rg 'android:text=' > text.txt

手动检查删除不需要的行，暂时不能精确的搜索出来
'''
